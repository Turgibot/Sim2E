...
def extract_txt(txt_path, output_path, zero_timestamps=False,
    ...
    num_images=100
    ep.set_data_available(num_images=num_images, num_flow=0)
    ...
    ep.add_metadata(total_num_pos, total_num_neg, last_ts-t0, t0, last_ts, num_imgs=num_images, num_flow=0, sensor_size=sensor_size)
    

def extract_txts(txt_paths, output_dir, zero_timestamps=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path", default="/home/guy/Projects/Results/Davis/txt_data/mug.txt", help="txt file to extract or directory containing txt files")
    parser.add_argument("--output_dir", default="/home/guy/Projects/Results/Davis/h5_data", help="Folder where to extract the data")
